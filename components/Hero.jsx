...
const Hero = () => (
  <section id='home' className={`flex md:flex-row flex-col md:items-center sm:px-0 px-6 ${Style.paddingY}`}>
    ...
    <div className={`flex-1 ${Style.flexCenter} md:my-0 my-10 relative `}>
    ...
    <div className={`sm:hidden ${Style.flexCenter}`}>
      <GetStarted />
    </div>
  </section>
)
