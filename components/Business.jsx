...
const FeatureCard = ({ icon, title, content, index }) => (
  <div className={`gap-6 flex flex-row p-6 rounded-[20px] feature-card`} >
    <div className={`w-[64px] h-[64px] flex justify-center items-center rounded-full bg-gray-400 `}>
    ...
    <div className='flex-1 flex flex-col m-3'>
      ...
      <p className='font-poppins font-normal text-gray-400 text-[16px] leading-24 mb-1'>
        {content}
      </p>
    </div>
  </div>
  ...
  return (
    <section id="features" className='flex md:flex-row flex-col sm:py-16 py-6' >
      <div className='flex-1 flex justify-center items-start flex-col'>
        ...
        <p className="font-poppins font-normal text-gray-400 text-[18px] leading-[30.8px] max-w-[470px] mt-5">With the right credit card, you can improve your financial life by building credit, earning rewards and saving money. But with hundreds of credit cards on the market.</p>
        <Button styles='mt-10' />
      </div>
